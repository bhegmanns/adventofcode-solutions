package de.hegmanns.training.aoc2022.day17.quicksolution;

import java.util.HashMap;
import java.util.Map;

public class QuickSolution17 {
    ...
    private static void part2() {
        Map<Pointers, Long> rows = new HashMap<Pointers, Long>();
        Map<Pointers, Integer> heights = new HashMap<Pointers, Integer>();
