...
import de.hegmanns.training.aoc2022.day24.grid.InfiniteGrid;
...
import static de.hegmanns.training.aoc2022.day24.Direction.*;

public class SolutionDay24 implements AoCSolution<Long, Long> {


    public static void main(String[] args) {
        List<String> inputAsList = AoCFileReader.getInputAsList(SolutionDay24.class, "day24.txt");

        SolutionDay24 solution = new SolutionDay24();
